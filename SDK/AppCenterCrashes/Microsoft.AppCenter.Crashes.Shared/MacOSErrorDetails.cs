...
{
    /// <summary>
    /// Error report details pertinent only to devices running macOS.
    /// </summary>
    public class MacOSErrorDetails
    {
        internal MacOSErrorDetails(string reporterKey, string signal, string exceptionName, string exceptionReason,
