...
{
    /// <summary>
    /// Error report details pertinent only to devices running tvOS.
    /// </summary>
    public class tvOSErrorDetails
    {
        internal tvOSErrorDetails(string reporterKey, string signal, string exceptionName, string exceptionReason,
